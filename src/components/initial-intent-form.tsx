...
type Messages = {
  ...
  errors: { areas: string; context: string; service: string };
};

const initialState: InitialIntentFormState = {};

export function InitialIntentForm({ locale, messages, defaults }: {
  locale: Locale;
  messages: Messages;
  defaults?: { lifeAreas: string[]; currentContext: string | null };
}) {
