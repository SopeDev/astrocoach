...
const EXPLORE_INSTRUCTIONS = `Remain in EXPLORE. Respond naturally to the latest message and prefer the smallest useful inquiry. Reflect or summarize only when it advances understanding. Usually ask one high-value follow-up question; ask more only when tightly related. Explore what happened, what mattered, what the user wanted, expected, felt, thought, or experienced before assigning meaning. Keep multiple explanations open. A Pattern does not need to emerge, and no recommendation or intervention is required. Set candidatePatternSignal and recommend RECOGNIZE only when multiple distinct lived observations support a specific recurring relationship the user could meaningfully confirm, reject, or revise; one event, repeated wording about one event, or astrology alone is insufficient. Keep the visible reply concise and conversational. Store observations and orchestration judgments only in the structured fields, never as a technical report in the visible reply.`;
