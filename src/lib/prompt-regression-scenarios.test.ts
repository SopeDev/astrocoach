...
test("prompt regression set covers the observed conversational failures", () => {
  assert.deepEqual(
    ...
    [
      ...
      "recognize-reclassification-does-not-create-recurrence",
      "integrate-one-bounded-practice",
      "integrate-declined-practice-is-not-replaced-automatically",
      "integrate-life-observation-is-evidence",
      "integrate-cue-too-late",
      "integrate-evidence-can-reopen-recognition",
      "deep-starts-from-recognized-focal-item",
      "deep-distinguishes-new-insight-from-revision",
      "deep-astrology-opens-inquiry",
      "deep-understanding-not-practice",
